    ...
    def render_workbench(self, user: dict, query: dict) -> str:
        ...
        if self.catalog_api_token and user.get("role") == "planner":
            try:
                ...
                sync_message = f"已自动同步 {count} 条藏宝阁资料。"
