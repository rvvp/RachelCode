...
def parse_args():
    parser = argparse.ArgumentParser(description="思安娜商品资料中心")
    ...
    parser.add_argument("--brand-name", default=env_text("CATALOG_BRAND_NAME", "思安娜商品资料中心"), help="系统品牌名称")
    parser.add_argument("--brand-mark", default=env_text("CATALOG_BRAND_MARK", "SA"), help="系统品牌简称")
    parser.add_argument("--brand-tagline", default=env_text("CATALOG_BRAND_TAGLINE", "让商品资料从分散表格进入统一底库"), help="登录页主文案")
    parser.add_argument("--brand-subtitle", default=env_text("CATALOG_BRAND_SUBTITLE", "面向商品、运营与渠道协作的内部资料后台，支持 A 主体填写、B 补充渠道价格、C 只读开放与结构化调用。"), help="登录页副文案")
    parser.add_argument("--brand-eyebrow", default=env_text("CATALOG_BRAND_EYEBROW", "Siana Merchandise Console"), help="登录页英文副标题")
    parser.add_argument("--brand-console-eyebrow", default=env_text("CATALOG_CONSOLE_EYEBROW", "Unified Catalog Workspace"), help="后台首页英文副标题")
